...
import { GetTweetHandler, ListUserTweetsHandler, ListTimelineHandler, GetLikesCountHandler, SearchTweetsHandler } from './application/handlers/tweet-query.handler';
...
const QueryHandlers = [GetTweetHandler, ListUserTweetsHandler, ListTimelineHandler, GetLikesCountHandler, SearchTweetsHandler];
